  ...
  const removeStatsRequirements = (name: string) => {
    switch (name) {
      ...
      case 'The Demons And The Crabs':
        stats.querySelector('stat[name="suicideHermitCrabsAchievementProgress"]')!.textContent = '0';
        break;
      case 'Cosmic Explorer':
        stats.querySelector('stat[name="totalTimesVisited.bazaar"]')!.textContent = '0';
        stats.querySelector('stat[name="totalTimesVisited.arena"]')!.textContent = '0';
        stats.querySelector('stat[name="totalTimesVisited.goldshores"]')!.textContent = '0';
        stats.querySelector('stat[name="totalTimesVisited.mysteryspace"]')!.textContent = '0'; // not sure what mysterypace is...
        stats.querySelector('stat[name="totalTimesVisited.artifactworld"]')!.textContent = '0';
        break;
      case 'Warm For Life':
        stats.querySelector('stat[name="totalBurnDeaths"]')!.textContent = '0';
        stats.querySelector('stat[name="totalDeathsWhileBurning"]')!.textContent = '0';
        break;
      case 'Mechanic':
        stats.querySelector('stat[name="totalDronesPurchased"]')!.textContent = '0';
        stats.querySelector('stat[name="totalTurretsPurchased"]')!.textContent = '0';
        break;
      case 'Funded!':
